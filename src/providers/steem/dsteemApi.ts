...
// steem blockchain api alternatives
//const MAINNET_OFFICIAL = 'https://api.steemit.com';
...
export const verifyPassoword = async (username: string, password: string) => {
  ...
  //password = ETAINCLUB_PASSWORD;
  // master password of etain1
  //  password = 'P5K46fKMCxgLf2eMqjzXT7iLiwxcnKTdvBuNVmUu1J4sz8U4xwuf';
  // active key
  // password = "5JLwkYWDRcmZ4F8x1QBFWH5iGwzrhLNjPjXE9cz1CiT8dbdwiPs";
  // owner key
  // password = "5K6ro3NoMnFjeWP9U4a3JqLCRM9xKTgQsmiNg1ANDHY7fvPkHBK";
